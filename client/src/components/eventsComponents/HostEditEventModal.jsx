...
export default function HostEditEventModal({ event, host, toggleEditEventModal }) {
    ...
    const handleSubmit = async (e) => {
        ...
        const updatedData = {
            ...formData,
            event_duration: durationString, // Use the string format for event_duration
            event_date_time: new Date(formData.event_date_time).toISOString() // Ensure date is formatted
        };
